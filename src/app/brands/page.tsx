    ...
    <>
      <section className="px-6 pt-16 pb-12 md:px-8 md:pt-24 md:pb-16">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="mt-7 max-w-4xl text-[28px] font-semibold leading-[1.08] tracking-[-0.035em] md:text-[44px] lg:text-[52px]">
            Every sponsorship{' '}
            <span className="text-altr-mint">in one place.</span>
          </h1>
          <p className="mt-6 max-w-2xl text-[15px] leading-[1.55] text-altr-text-2 md:text-[16px]">
